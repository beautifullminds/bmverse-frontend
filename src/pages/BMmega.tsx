        ...
        <div className="content text-center">
          ...
          <div className="flex flex-wrap mt-4">
            ...
            >
              <p className="text-left text-19 font-medium" style={bgStyle}>
                ...
                in the field of video games’ characters. This collection
                consists of 50 unique collections, each of which contains 12
                unique characters with a fascinating and astonishing story.
              </p>
            </div>
          </div>
          <div
          ...
          <div>
            <p className="text-left text-19 font-medium" style={bgStyle}>
              ...
              position and form, each of which conveys an important message. In
              the Mega Collection, the bridge is made from imagination to
          ...
          <div className="flex flex-wrap mt-[80px]">
            ...
            >
              <p className="md:p-[20px] md:pr-[40px]">
                The life story of these 12 ants is mysteriously tied together in
                such a way that it is difficult to guess the beginning and the
                end of this strange story. The desire for immortality in one has
                ignited a flame in the heart of the other so that both of them
                can be a factor in the revolution in a government that another
                ant has planned for centuries. These mutant ants are interacting
                with each other and their ability to grow and improve is still
                active. Their biggest characteristic is rarity, so that with the
          ...
          <div className="flex flex-wrap mt-[20px]">
            ...
            >
              <p className="text-33 font-semibold mt-4">“ANTVerse” in Gaming</p>
              <p className="text-left text-19 font-medium mt-4" style={bgStyle}>
                ...
                collection. On the other hand, the features and capabilities of
                these characters have also become NFT and are tradable. Even the
                cards that enhance the abilities of the characters (known as
                Magical Potion) are works of art that have no equivalent in the
                real world and are offered in NFT format.
              </p>
            </div>
            <div
            ...
            >
              <div className="md:pr-[65px] text-left">
                ...
                <p
                  ...
                  style={bgStyle}
                >
                  You can use BMJewel hashed items to activate the first unique
                  abilities (out of 3) of each character; By buying jewelry for
                  your character’s ability, use the code engraved on it to
                  activate the desired ability.
                </p>
              </div>
            </div>
            <div
            ...
            >
              <div className="md:pl-[65px] text-left">
                ...
                >
                  ...
                  NFT Market Place. Magical potions are actually a part of works
                  of art that were created 40 years ago in the field of pen
                  dotting.
                </p>
              </div>
            </div>
          ...
          <div className="text-left text-16 font-semibold" style={bgStyle}>
            <p className="max-w-[800px] pb-4">
              ...
              the characteristics by using coding and so on. After receiving the
              third ability of each character, you will actually have access to
              one of the codes available in the Last Supper work. The Ant Verse
              Last Supper is a work of art taken from Da Vinci’s Last Supper, in
              which all 12 characters are mysteriously standing around a table
