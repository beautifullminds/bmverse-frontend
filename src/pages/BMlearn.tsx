      ...
      <div className="bm-content">
        <div className="text-center mt-[30px]">
          ...
          <p className="text-28 font-medium mt-4">
            The Decentralized and Specialized Educational Platform Resistant to
            Censorship
          </p>
          <div
        ...
        >
          ...
          <p>
            ...
            future generations, and this is exactily where the capitalist system
            will try to change the entire educational content for its own
            benefit. In bm learn, all educational content is first approved by
            the proof of content consensus algorithm in a completely
            decentralized manner under the supervision of the most specialized
            educational centers in the world and is hashed in the blockchain
            network before any censorship. As it was said, we create nft
            educational content at bmlearn. In fact, we are building and
            completing an educational platform that connects the world of
            education to the world of nfts, so that the rights of the content
            creators are completely saved, and the produced content is safe from
            any censorship. In fact, the two principles of purity and rarity
            will be in all the content available in bmlearn.
          </p>
          <div
        ...
        <div className="content text-center z-10">
          <div className="md:grid grid-cols-2 mt-[30px]">
            ...
            >
              ...
              <p className="mt-5" style={bg2Style}>
                ...
                most specialized educational centers in the world and is hashed
                in the blockchain network before any censorship. As it was said,
                we create nft educational content at bmlearn. In fact, we are
                building and completing an educational platform that connects
                the world of education to the world of nfts, so that the rights
                of the content creators are completely saved, and the produced
                content is safe from any censorship. In fact, the two principles
                of purity and rarity will be in all the content available in
                bmlearn.
              </p>
            </div>
          </div>
          <div className="md:grid grid-cols-2 mt-[30px]">
            ...
            >
              ...
              <p className="mt-5" style={bg2Style}>
                ...
                category is on the alpha generation, but This does not mean that
                other people will not have a Place in this educational platform.
                In fact, teachers of generation alpha will be the (gen-z). The
                creators and owners of the content produced in this educational
                platform will be generation z. In this way, bmlearn will create
                an unbreakable bond between the savior generation and their
                teachers.
              </p>
            </div>
            <div
          ...
          <p className="mt-[40px] md:text-22 md:w-5/6 m-auto">
            ...
            transfer is under human control, consequences such as censorship and
            plagiarism will not be out of Mind. In such a platform (which we
            have seen so far under the name of various educational websites), no
            learner is placed on the path of learning with 100% confidence in
            the authenticity of the content. On the other hand, publishers of
            educational content who spend a lot of time and money to produce a
            training course need to be sure that the result of their efforts is
            not published on another platform and under the name of another
            person. Otherwise, no one will have the motation to produce
            ...
            >
              <div className="text-left">
                ...
                <p className="mt-5" style={bg2Style}>
                  ...
                  bmgroup, in cooperation with the most prestigious universities
                  and Scientific centers located all over the world, has
                  provided a path in which all centers speicalizing in different
                  sciences work together to confirm the Scientific validity of a
                  content and of course receive rewards for their activity.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="text-left mt-[100px]" style={bg2Style}>
            Learning and how to learn are issues that are ignored in centralized
            educational systems. The limitation of information, the orientation
            of the learning process, and the psychological damage to students
            are among the disasters of the current centralized education
            systems, in bm learn, the main focus is on the way of learning. We
            provide information to our users without personal judgment and in
            the direction of helping personal and social development. Business
            investment and development, futurism, blockchain and cryptocurrency,
            ai, and all kinds of practical information on the internet and
            blockchain are totally covered in bm learn.
          </div>
        </div>
      </div>
