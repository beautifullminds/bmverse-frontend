          ...
          <div className="content text-center z-10">
              ...
              <div className="text-left mt-4">
                <AnimationOnScroll animateIn="bounceInRight">
                  ...
                  <p className="mt-5" style={bg2Style}>
                    The exchange of educational information will reach its peak
                    in future generations, and this is exactily where the
                    capitalist system will try to change the entire educational
                    content for its own benefit. In bm learn, all educational
                    content is first approved by the proof of content consensus
                    algorithm in a completely decentralized manner under the
                    supervision of the most specialized educational centers in
                    the world and is hashed in the blockchain network before any
                    censorship. As it was said, we create nft educational
                    content at bmlearn. In fact, we are building and completing
                    an educational platform that connects the world of education
                    to the world of nfts, so that the rights of the content
                    creators are completely saved, and the produced content is
                    safe from any censorship. In fact, the two principles of
                    purity and rarity will be in all the content available in
                    bmlearn.
                  </p>
                </AnimationOnScroll>
              </div>
            ...
            <AnimationOnScroll animateIn="fadeIn">
              ...
              <p className="mt-[40px] md:text-22 md:w-5/6 m-auto">
                ...
                and plagiarism will not be out of Mind. In such a platform
                (which we have seen so far under the name of various educational
                websites), no learner is placed on the path of learning with
                100% confidence in the authenticity of the content. On the other
                hand, publishers of educational content who spend a lot of time
                and money to produce a training course need to be sure that the
                result of their efforts is not published on another platform and
                under the name of another person. Otherwise, no one will have
                the motation to produce professional content.
              </p>
            </AnimationOnScroll>
                ...
                <AnimationOnScroll animateIn="bounceInRight">
                  <div className="text-left">
                    ...
                    <p className="mt-5" style={bg2Style}>
                      ...
                      guarantees that no content outside the logic of science
                      will be published. The proof of content algorithm, which
                      is the result of round the clock research by the experts
                      of the bmgroup, in cooperation with the most prestigious
                      universities and Scientific centers located all over the
                      world, has provided a path in which all centers
                      speicalizing in different sciences work together to
                      confirm the Scientific validity of a content and of course
                      receive rewards for their activity.
                    </p>
                  </div>
                </AnimationOnScroll>
              </div>
            ...
            <AnimationOnScroll animateIn="fadeIn">
              ...
              <p className="mt-[40px] md:text-22 md:w-5/6 m-auto">
                Bm learn aims to create an environment to earn money for
                teachers and students and to upgrade the level of knowledge in
                the field of blockchain, advanced and innovative technologies
                and cryptocurrencies based on a native token.
              </p>
            </AnimationOnScroll>
            <AnimationOnScroll animateIn="bounceInRight">
              <div className="md:grid grid-cols-6 md:w-5/6 mx-auto gap-5 mt-[20px] text-left">
            ...
            <AnimationOnScroll animateIn="bounceInLeft">
              <div className="text-left mt-[100px]" style={bg2Style}>
                ...
                social development. Business investment and development,
                futurism, blockchain and cryptocurrency, ai, and all kinds of
                practical information on the internet and blockchain are totally
                covered in bm learn.
              </div>
            </AnimationOnScroll>
          </div>
