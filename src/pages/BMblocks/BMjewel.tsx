        ...
        <div className="bm-content">
          <div className="content text-center bg-transparent">
            ...
            <div className="xl:grid grid-cols-2 mt-[140px] md:mt-[350px]">
              ...
              <div className="flex items-center p-2 md:pl-[60px]">
                ...
                >
                  ...
                  their high value. These jewels, which are all made by hand,
                  have a high inherent value due to the artistic design done on
                  them. The origin of these jewels are actually the abilities
                  and capabilities of the characters in the Mega Collection, so
                  that the owner of each of these jewels can activate a special
                  feature for their characters and promote it by using the codes
                  engraved on them.
                </div>
              </div>
            </div>
            ...
            <div className="mt-[50px] text-24 md:text-36 font-semibold text-left md:w-4/5">
              ...
              and artists, and months of time have been spent to prepare each of
              them, and finally all are traceable on the BM Group native NFT
              Market Place.
            </div>
          </div>
        </div>
